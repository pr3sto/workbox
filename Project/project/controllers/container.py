...
class ContainerController(BaseController):
    ...
    @expose()
    def index(self):
        redirect('/container/new')

    @expose('project.templates.container_new')
    def new(self):
        return dict(page='container_new')
    ...
    def create(self):
        ...
        return HTTPFound(location='/container/new')

    @expose('project.templates.container_list')
    def list(self):
        entries = model.Container.query.find()
        return dict(page='container_list', entries=entries)
