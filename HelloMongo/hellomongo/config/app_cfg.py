# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in HelloMongo.
...
import hellomongo
from hellomongo import model, lib
...
base_config.package = hellomongo
...
base_config.model = hellomongo.model
base_config.DBSession = hellomongo.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'ming'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "cf09c254-2881-4d88-a72f-800aa27cbccd"
